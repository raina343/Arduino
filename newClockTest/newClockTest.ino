...
int numberUK7[] = {0, 1, 2, 12, 13, 15, 18, 19, 20};
...
void setup() {
  ...
  while (status != WL_CONNECTED) {
    ...
    strip.setPixelColor(128, strip.Color(255, 255, 0));
    strip.setPixelColor(129, strip.Color(255, 255, 0));
    strip.show();
  ...
  strip.setPixelColor(128, strip.Color(255, 255, 255));
  strip.setPixelColor(129, strip.Color(255, 255, 255));
