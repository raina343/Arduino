...
void GetTime() {
  ...
  if (err == 1) {
    ...
    strip.setPixelColor(10, strip.Color(150, 150, 150));
    strip.setPixelColor(11, strip.Color(150, 150, 150));
    strip.setPixelColor(14, strip.Color(150, 150, 150));
    strip.setPixelColor(15, strip.Color(150, 150, 150));
   
    
    strip.setPixelColor(30, strip.Color(150, 150, 150));
    strip.setPixelColor(31, strip.Color(150, 150, 150));
    strip.setPixelColor(44, strip.Color(150, 150, 150));
    strip.setPixelColor(45, strip.Color(150, 150, 150));
  
    strip.setPixelColor(24, strip.Color(150, 150, 150));
    strip.setPixelColor(25, strip.Color(150, 150, 150));
    strip.setPixelColor(40, strip.Color(150, 150, 150));
    strip.setPixelColor(41, strip.Color(150, 150, 150));
    strip.setPixelColor(54, strip.Color(150, 150, 150));
    strip.setPixelColor(55, strip.Color(150, 150, 150));

    strip.setPixelColor(20, strip.Color(150, 150, 150));
    strip.setPixelColor(21, strip.Color(150, 150, 150));
    strip.setPixelColor(36, strip.Color(150, 150, 150));
    strip.setPixelColor(37, strip.Color(150, 150, 150));
