...
WiFiUDP Udp;
#define Top_Clock_LED_PIN 6
#define Bottom_Clock_LED_PIN 7
#define Date_LED_PIN 8
#define Day_LED_PIN 4
#define Top_Clock_LED_COUNT 86
#define Bottom_Clock_LED_COUNT 86
#define Date_LED_COUNT 106
#define Day_LED_COUNT 78
...
int pixels[58];
String WIFiWAPList;
Adafruit_NeoPixel stripTopClock(Top_Clock_LED_COUNT, Top_Clock_LED_PIN, NEO_GRB + NEO_KHZ800);
//Adafruit_NeoPixel stripBottomClock(Bottom_Clock_LED_COUNT, Bottom_Clock_LED_PIN, NEO_GRB + NEO_KHZ800);
//Adafruit_NeoPixel stripDate(Date_LED_COUNT, Date_LED_PIN, NEO_GRB + NEO_KHZ800);
//Adafruit_NeoPixel stripDay(Day_LED_COUNT, Day_LED_PIN, NEO_GRB + NEO_KHZ800);
...
void setup() {
  ...
  stripTopClock.begin();  // INITIALIZE NeoPixel stripTopClock object (REQUIRED)
  stripTopClock.show();   // Turn OFF all pixels ASAP
  stripTopClock.clear();
   
   
//   stripBottomClock.begin();  // INITIALIZE NeoPixel stripTopClock object (REQUIRED)
//  stripBottomClock.show();   // Turn OFF all pixels ASAP
//  stripBottomClock.clear();
//   
//   
//   stripDate.begin();  // INITIALIZE NeoPixel stripTopClock object (REQUIRED)
//  stripDate.show();   // Turn OFF all pixels ASAP
//  stripDate.clear();
//  
//   
//   stripDay.begin();  // INITIALIZE NeoPixel stripTopClock object (REQUIRED)
//  stripDay.show();   // Turn OFF all pixels ASAP
//  stripDay.clear();
  
  
  stripTopClock.setBrightness(150);
...
//      stripTopClock.setPixelColor(9, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(10, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(11, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(30, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(31, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(32, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(53, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(54, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(55, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(74, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(75, stripTopClock.Color(255, 75, 250));
//      stripTopClock.setPixelColor(76, stripTopClock.Color(255, 75, 250));
//      stripTopClock.show();
      // 48 and 49
...
//      stripTopClock.setPixelColor(9, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(10, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(11, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(30, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(31, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(32, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(53, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(54, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(55, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(74, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(75, stripTopClock.Color(255, 0, 0));
//      stripTopClock.setPixelColor(76, stripTopClock.Color(255, 0, 0));
//      stripTopClock.show();
      while (true)
        ;
    }
...
//      stripTopClock.setPixelColor(9, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(10, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(11, stripTopClock.Color(255, 255, 0));
      stripTopClock.setPixelColor(30, stripTopClock.Color(255, 255, 0));
      stripTopClock.setPixelColor(31, stripTopClock.Color(255, 255, 0));
      stripTopClock.setPixelColor(32, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(53, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(54, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(55, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(74, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(75, stripTopClock.Color(255, 255, 0));
//      stripTopClock.setPixelColor(76, stripTopClock.Color(255, 255, 0));
      stripTopClock.show();
  } else {
    // we have saved credentials, so we start up normally. middle row green
//      stripTopClock.setPixelColor(9, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(10, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(11, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(30, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(31, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(32, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(53, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(54, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(55, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(74, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(75, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(76, stripTopClock.Color(0, 150, 0));
//    stripTopClock.show();
...
//      stripTopClock.setPixelColor(0, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(1, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(2, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(21, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(22, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(23, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(44, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(45, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(46, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(65, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(66, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(67, stripTopClock.Color(255, 0, 0));
      ...
      delay(5000);
      server.begin();
      // stripTopClock.setPixelColor(28, stripTopClock.Color(255, 0, 0));
      // stripTopClock.setPixelColor(29, stripTopClock.Color(255, 0, 0));
      // stripTopClock.show();
      if (WiFi.status() == WL_NO_MODULE) {  // module failed.  middle row red
      stripTopClock.setPixelColor(15, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(16, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(17, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(36, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(37, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(38, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(59, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(60, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(61, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(80, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(81, stripTopClock.Color(255, 0, 0));
      stripTopClock.setPixelColor(82, stripTopClock.Color(255, 0, 0));
        stripTopClock.show();
        Serial.println("Communication with WiFi module failed!");
        while (true)
          ;
...
//      stripTopClock.setPixelColor(0, stripTopClock.Color(0, 150, 0));
//      stripTopClock.setPixelColor(1, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(2, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(21, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(22, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(23, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(44, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(45, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(46, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(65, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(66, stripTopClock.Color(0, 150, 0));
      stripTopClock.setPixelColor(67, stripTopClock.Color(0,150, 0));
        stripTopClock.show();
      ...
      stripTopClock.setPixelColor(42, stripTopClock.Color(0, 255, 0));
      stripTopClock.setPixelColor(43, stripTopClock.Color(0, 255, 0));
      stripTopClock.show();
      printWifiStatus();
...
uint32_t Wheel(byte WheelPos) {
  if (WheelPos < 85) {
    return stripTopClock.Color(WheelPos * 3, 255 - WheelPos * 3, 0);
  } else if (WheelPos < 170) {
    WheelPos -= 85;
    return stripTopClock.Color(255 - WheelPos * 3, 0, WheelPos * 3);
  } else {
    WheelPos -= 170;
    return stripTopClock.Color(0, WheelPos * 3, 255 - WheelPos * 3);
  }
}
...
void loop() {
  ...
  if (WifiSetup == 0) {
    ...
    for (j = 0; j < 256; j++) {
      for (i = 0; i < stripTopClock.numPixels(); i++) {
        if (pixels[i] == -1) {
          stripTopClock.setPixelColor(i, Wheel((i * 14 + j) & 255));
        } else {
          stripTopClock.setPixelColor(i, stripTopClock.Color(0, 0, 0));
        }
      }
      stripTopClock.show();
      delay(15);
    ...
    if ((String)owner.dimmer == "of") {
      ...
      stripTopClock.setBrightness(BrightnessLevel.toInt());
      stripTopClock.show();
    } else {
      lightvalue = analogRead(pResistor);
      //      Serial.println(lightvalue);
      if (lightvalue > 550) {
        stripTopClock.setBrightness(255);
        stripTopClock.show();
      }
      ...
      if (lightvalue < 150) {
        stripTopClock.setBrightness(20);
        stripTopClock.show();
      }
    }
  }
...
client.println("</li>");
        ...
        if (c == '\n') {
          ...
          if (readString.indexOf("ssid") > 0) {
            stripTopClock.setPixelColor(6, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(7, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(20, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(21, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(36, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(37, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(50, stripTopClock.Color(150, 0, 150));
            stripTopClock.setPixelColor(51, stripTopClock.Color(150, 0, 150));
            stripTopClock.show();
            // Serial.println(readString);
            char Buf[250];
            ...
            if (returnedip == "0.0.0.0") {
              Serial.println("Wifi Failed");
              status = WiFi.beginAP(ssid);
              stripTopClock.setPixelColor(6, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(7, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(20, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(21, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(36, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(37, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(50, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(51, stripTopClock.Color(255, 0, 0));

//              stripTopClock.setPixelColor(0, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(1, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(14, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(15, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(30, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(31, stripTopClock.Color(255, 0, 0));
              stripTopClock.setPixelColor(44, stripTopClock.Color(255, 0, 0));
              ...
              stripTopClock.setPixelColor(50, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(51, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(37, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(36, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(6, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(7, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(20, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(21, stripTopClock.Color(0, 0, 255));

//              stripTopClock.setPixelColor(0, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(1, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(14, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(15, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(30, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(31, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(44, stripTopClock.Color(0, 0, 255));
              stripTopClock.setPixelColor(45, stripTopClock.Color(0, 0, 255));
              stripTopClock.show();
              // server.begin();
              owner.valid = true;
              my_flash_store.write(owner);
...
void GetTime() {
  ...
  if (err == 1) {
    ...
    if (Udp.parsePacket()) {
      ...
      //     delay(3000);
      stripTopClock.setPixelColor(28, stripTopClock.Color(0, 0, 255));
      stripTopClock.setPixelColor(29, stripTopClock.Color(0, 0, 255));
      stripTopClock.show();
      ...
      stripTopClock.setPixelColor(1, stripTopClock.Color(150, 0, 0));
//      stripTopClock.setPixelColor(0, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(14, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(15, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(30, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(31, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(44, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(45, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(10, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(11, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(24, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(25, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(40, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(41, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(54, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(55, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(6, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(7, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(20, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(21, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(36, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(37, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(50, stripTopClock.Color(150, 0, 0));
      stripTopClock.setPixelColor(51, stripTopClock.Color(150, 0, 0));
      stripTopClock.show();
      delay(10000);
    }
  } else {
    ...
    stripTopClock.setPixelColor(1, stripTopClock.Color(150, 150, 150));
//    stripTopClock.setPixelColor(0, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(14, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(15, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(30, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(31, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(44, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(45, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(10, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(11, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(24, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(25, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(40, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(41, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(54, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(55, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(6, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(7, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(20, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(21, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(36, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(37, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(50, stripTopClock.Color(150, 150, 150));
    stripTopClock.setPixelColor(51, stripTopClock.Color(150, 150, 150));
    stripTopClock.show();
    delay(10000);
  }
...
//
//  const byte ARRAY_SIZE = numSsid;
//
//String WIFiWAPList[ARRAY_SIZE];
////numSsid
...
//    WIFiWAPList[thisNet] = WiFi.SSID(thisNet);
////    myArray[thisNet] = (string)WiFi.SSID(thisNet);
//    Serial.print("\tSignal: ");
//
